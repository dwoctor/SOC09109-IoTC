...
import uk.ac.napier.communicator.communication.devices.DeviceAdapter;
...
public class WifiLocalNewUiTest extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wifi_local_new_ui_test);
    ...
    private ArrayAdapter getDevicesListAdapter() {
        if (this.devicesAdapter == null) {
            DeviceAdapter devicesAdapter = new DeviceAdapter(this, Devices.getInstance().getDevices());
